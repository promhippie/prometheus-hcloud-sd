 ...
 * Chg #20: Update Go version and dependencies
 ...
 * Change #20: Update Go version and dependencies
 ...
 * Bugfix #16: Normalize specialchars in labels
   ...
   Since you can use dots and dashes as part of your labels within Hetzner Cloud we started to
   replace these characters by an underscore now, otherwise this will result in invalid labels
   for Prometheus.
